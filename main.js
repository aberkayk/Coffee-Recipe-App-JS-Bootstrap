...
function displayRecipes(){
    ...
    <div class="col">
        <div class="p-4 m-4 row shadow-sm border-primary">
            <div class="card-hedaer py-3 text-white bg-primary border-primary">
...
// Event Listeners
recipeForm.addEventListener('submit', formSubmit);
